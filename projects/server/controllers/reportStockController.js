...
module.exports = {
    fetchStockMovementHistory: async (req, res) => {
        try {
            ...
            pengurangan_order as (select id_order as id_stock_movement_reference_id, id_product, id_warehouse, -1*quantity as quantity , created_at, "order" as movement_description from orders_and_items),
            ...
            select months, movement_description, stock_movement_reference_id, id_product, id_warehouse, quantity, created_at from history2 where id_warehouse in (${id_warehouse})`;
