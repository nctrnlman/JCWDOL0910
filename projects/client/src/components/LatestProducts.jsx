...
function LatestProducts() {
    const latest_products = useSelector((state) => state.latestProducts.latest_products);
    ...
    return (
        <div>
            ...
            <div id="content" className=" bg-slate-200 flex items-center justify-center m-10 rounded">
